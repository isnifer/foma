...
/***/ function(module, exports, __webpack_require__) {
	...
	var _valya = __webpack_require__(158);

	var _valya2 = _interopRequireDefault(_valya);

	var _libIndex = __webpack_require__(237);
	...
	var groupFieldValidator = function groupFieldValidator(fieldName, invalidFields) {
	    return {
	        validator: function validator(value, params) {
	...
	var GroupComponent = (function (_Component2) {
	    ...
	    _createClass(GroupComponent, [{
	        key: 'onEndCallback',
	        value: function onEndCallback(name) {
	            var _this = this;
	            ...
	            return fields.map(function (field, i) {
	                return _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        Validator,
	                        {
	                            value: _this2.props.group[field],
	                            onEnd: _this2.onEndCallback(field),
	                            validators: [groupFieldValidator(field, _this2.props.invalidFields)],
	                        ...
	                        _react2['default'].createElement('input', {
	                            ...
	                            value: _this2.props.group[field],
	                            onChange: _this2.props.setGroupField.bind(_this2, field, _this2.props.index) })
	                    )
	                );
	            });
	        }
	    }, {
	        key: 'groupOnEndCallback',
	        value: function groupOnEndCallback(name) {
	            var _this3 = this;

	            return function (isValid, message) {
	                _this3.props.updateParentValidation({ isValid: isValid, message: message, name: name });
	            };
	        }
	    }, {
	        key: 'render',
	                    ...
	                    validators: [{
	                        validator: function validator(group, params) {
	                            ...
	                            if (allFieldsAreEmpty) {
	                                ...
	                                if (_this4.props.allGroups.length === 1) {
	                                    return Promise.reject(params.allFieldsRequired);
	                                }

	                                if (_this4.props.allGroups.length > 1 && !_this4.props.index) {
	                                    return Promise.reject(params.allFieldsRequired);
	                                }
	...
	var FormDemo = (function (_Component3) {
	    ...
	    function FormDemo(props, context) {
	    ...
	    _createClass(FormDemo, [{
	        ...
	        value: function onEndCallback(name) {
	            ...
	            return function (isValid, message) {
	                _this5.props.foma.setValidationInfo({ isValid: isValid, message: message, name: name });
	            };
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        ...
	                        ['chrome', 'firefox', 'opera', 'safari'].map(function (browser) {
	                            return _react2['default'].createElement(
	                                'div',
	                                {
	                                    className: browser + (_this6.state.browser === browser ? ' selected' : ''),
	                                    onClick: _this6.setBrowser.bind(_this6, browser),
	                                    key: browser },
	                                browser
	                            );
	                        })
	                ...
	                this.state.groups.map(function (group, i) {
	                    ...
	                    var props = {
	                        group: group,
	                        allGroups: _this6.state.groups,
	                        allInvalidGroups: _this6.props.childrenInvalidFields.length,
	                        setGroupField: _this6.setGroupField.bind(_this6),
	                        updateParentValidation: (_context = _this6.props.foma).setChildrenValidationInfo.bind(_context),
	                        index: i,
	                        key: i
	                    };

	                    return _react2['default'].createElement(GroupComponent, props);
	                }),
	                _react2['default'].createElement(
	                    'div',
	                    { className: 'form-group' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extends = __webpack_require__(188)['default'];

	var _Promise = __webpack_require__(195)['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(171).Promise;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LIBRARY         = __webpack_require__(202)
	  ...
	  , $redef          = __webpack_require__(203)
	  , hide            = __webpack_require__(204)
	  , has             = __webpack_require__(207)
	  , SYMBOL_ITERATOR = __webpack_require__(208)('iterator')
	...
	module.exports = function(Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCE){
	  __webpack_require__(212)(Constructor, NAME, next);
	  ...
	  // Fix native
	  if(_native){
	    var IteratorPrototype = __webpack_require__(162).getProto(_default.call(new Base));
	    // Set @@toStringTag to native iterators
	    __webpack_require__(213)(IteratorPrototype, TAG, true);
	    // FF fix
	  ...
	  if(DEFAULT){
	    ...
	    } else $def($def.P + $def.F * __webpack_require__(214), NAME, methods);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(name){
	  return store[name] || (store[name] =
	    Symbol && Symbol[name] || (Symbol || __webpack_require__(210))('Symbol.' + name));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(204)(IteratorPrototype, __webpack_require__(208)('iterator'), function(){ return this; });

	module.exports = function(Constructor, NAME, next){
	  Constructor.prototype = $.create(IteratorPrototype, {next: __webpack_require__(205)(1,next)});
	  __webpack_require__(213)(Constructor, NAME + ' Iterator');
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var useNative = function(){
	  ...
	  try {
	    ...
	    if(works && __webpack_require__(206)){
	...
	__webpack_require__(213)(P, PROMISE);
	species(P);
	species(Wrapper = __webpack_require__(171)[PROMISE]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var classof   = __webpack_require__(220)
	  , ITERATOR  = __webpack_require__(208)('iterator')
	  , Iterators = __webpack_require__(211);
	module.exports = __webpack_require__(171).getIteratorMethod = function(it){
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(C){
	  if(__webpack_require__(206) && !(SPECIES in C))$.setDesc(C, SPECIES, {
	    configurable: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $redef = __webpack_require__(203);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SYMBOL_ITERATOR = __webpack_require__(208)('iterator')
	  , SAFE_CLOSING    = false;
	try {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = function (Foma) {
	    return (function (_Component) {
	        ...
	        _createClass(_class, [{
	            key: '_manageInvalidFields',
	            value: function _manageInvalidFields(invalidFields, validatorInfo, idx) {
	                this.setState({
	                    isValidating: true,
	                    isValid: false,
	                    isInvalid: true
	            ...
	            value: function setChildrenValidationInfo(validatorInfo) {
